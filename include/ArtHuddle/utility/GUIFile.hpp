...
const std::string TEXTBOX_OPEN = "<textbox>";
const std::string TEXTBOX_CLOSE = "</textbox>";
const std::string ELLIPSE_OPEN = "<ellipse>";
const std::string ELLIPSE_CLOSE = "</ellipse>";
const std::string ARROW_OPEN = "<arrow>";
const std::string ARROW_CLOSE = "</arrow>";
const std::string FREEHAND_OPEN = "<freehand>";
const std::string FREEHAND_CLOSE = "</freehand>";
...
const std::vector<std::string> OPENERS = {LAYOUT_OPEN, LINE_OPEN, BOX_OPEN, POINT_OPEN, TRIANGLE_OPEN, BUTTON_OPEN, TEXTBOX_OPEN,  ELLIPSE_OPEN, ARROW_OPEN, FREEHAND_OPEN, VEC2_OPEN, VEC3_OPEN, IVEC2_OPEN, IVEC3_OPEN, X_OPEN, Y_OPEN, Z_OPEN};
const std::vector<std::string> CLOSERS = {LAYOUT_CLOSE, LINE_CLOSE, BOX_CLOSE, POINT_CLOSE, TRIANGLE_CLOSE, BUTTON_CLOSE, TEXTBOX_CLOSE, ELLIPSE_CLOSE, ARROW_CLOSE, FREEHAND_CLOSE, VEC2_CLOSE, VEC3_CLOSE, IVEC2_CLOSE, IVEC3_CLOSE, X_CLOSE, Y_CLOSE, Z_CLOSE};
