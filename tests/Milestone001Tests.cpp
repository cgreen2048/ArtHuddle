...
int main() {
    int failure = 0;
    if (vec2_tester()) failure = 1;
    printf("\n");
    if (ivec2_tester()) failure = 1;
    printf("\n");
    if (vec3_tester()) failure = 1;
    printf("\n");
    if (ivec3_tester()) failure = 1;
    printf("\n");
    if (matrix_tester()) failure = 1;
    printf("\n");
    if (failure) std::cout << "IMPLEMENTATION(S) FAILED, REVIEW TEST RESULTS\n";
...
int vec2_tester() {
    ...
    else std::cout << "copy constructor working\n";
    ...
    else std::cout << "add function working\n";

    float scalar = 4.5;
    expected = vec2(11.25, 15.75);
    result = test * scalar;
    if (expected == result) std::cout << "scalar mult function working\n";
    else {
    ...
    result = test - test;
    if (expected == result) std::cout << "subtract function working\n";
    else {
    ...
    if (expected4 == result4) std::cout << "dot product function working\n";
    else {
    ...
    if (expected5 == result5) std::cout << "magnitude function working\n";
    else {
    ...
    if (expected == test) std::cout << "self-assign add function working\n";
    else {
    ...
    if (expected == test) std::cout << "self-assign scalar mult function working\n";
    else {
    ...
    test-= test;
    expected = vec2(0.0, 0.0);
    if (expected == test) std::cout << "self-assign subtract function working\n";
    else {
...
int vec3_tester() {
    ...
    if (expected == result) std::cout << "cross product function working\n";
    else {
...
int matrix_tester() {
    ...
    else std::cout << "matrix multiplication function working\n";
    ...
    if (test9.transpose() == transpose) std::cout << "transpose function working\n";
    else {
